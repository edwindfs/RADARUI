                    ...
                    if is_locked:
                        ...
                        try: 
                            ...
                            payload = {
                                ...
                                "altitude_m": round(rel_alt, 1)
                            }

                            json_string=json.dumps(payload) + "\n"
                            self.serial_conn.write(json_string.encode('utf-8'))
                            print(f"[INFO] Sent target coordinates over serial: {json_string.strip()}")  
                            ...
                            pass # suppress warning spam if radio disconnected during lock
